  ...
  return (
    <div className="projects">
      <div className="projects-content">
        <h4>Real-Time Data Correlation for Unity Interface</h4>
        ...
        <p> 
          <ul> 
            ...
            <li>Developed track correlation logic based on requirements, ensuring accurate association of incoming data streams to properly serve to frontend.</li>
          </ul>
        </p>
        </div>
      </div>
